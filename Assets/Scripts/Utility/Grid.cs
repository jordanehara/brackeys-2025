...
public class Grid
{
    ...
    public Grid(int width, int height, float cellSize, Vector3 originPosition, bool hideGrid)
    {
        this.width = width;
        this.height = height;
    ...
    private void DisplayGrid()
    {
        ...
        for (int x = 0; x < gridArray.GetLength(0); x++)
        {
            ...
            {
                debugTextArray[x, y] = CreateWorldText(gridArray[x, y].ToString(), null, GetWorldPosition(x, y) + new Vector3(cellSize, cellSize) * 0.5f, 10, Color.white, TextAnchor.MiddleCenter);
    ...
    public void SetValue(int x, int y, int value)
    {
        ...
        {
            gridArray[x, y] = value;
            if (!hideGrid && debugTextArray != null)
